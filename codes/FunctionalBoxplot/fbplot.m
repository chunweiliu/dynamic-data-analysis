...
function [depth, outpoint, medianCurveId, posPercentile, centralRegionId]=fbplot(data,x,depth,method,show,prob,color,outliercol,barcol,fullout,factor,sampleData,boundarycolor)
...
%%default values
if nargin<13,   boundarycolor = 'b'; end
if nargin<12,   sampleData=[]; end
...
if show 
    plot(x,maxcurve,'Color',boundarycolor,'LineWidth',2);
    plot(x,mincurve,'Color',boundarycolor,'LineWidth',2);
end
hold off;
